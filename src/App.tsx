...
import { IsIlanlari } from "./pages/admin/IsIlanlari";
...
import { BelgeAnalizi } from './pages/calisan/BelgeAnalizi';
...
import { IsIlanlariMusteri } from './pages/musteri/IsIlanlariMusteri';
        ...
        <TicketProvider>
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/admin/is-ilanlari" element={<IsIlanlari />} />
              ...
              <Route path="/calisan/belge-analizi" element={<ProtectedRoute allowedRoles={['employee']}><BelgeAnalizi /></ProtectedRoute>}/>
              ...
              <Route path="/musteri/is-ilanlari" element={<IsIlanlariMusteri />} />
