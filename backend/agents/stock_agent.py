...
async def get_stock_advice(company_id: str, mode: str = "advice") -> dict:
    if mode == "morning":
        user_prompt = (
            ...
            "Araclari kullanarak stok ve kargoya verilmeyi bekleyen siparis verilerini cek. "
            "Kullaniciya dostca bir 'Gunaydin!' diyerek basla. "
            "Bugun kargolanacak siparisleri ve kritik stoklari ozetleyen sabah raporu yaz."
        )
    elif mode == "evening":
        user_prompt = (
            f"Sirket ID: {company_id}\n"
            "Araclari kullanarak stok ve siparis verilerini cek. "
            "Kullaniciya 'Iyi aksamlar!' diyerek basla. "
            "Bugunku genel durumu, toplam siparisleri ve gun sonu stok degerlendirmesini iceren bir gun ozeti yaz."
        )
    elif mode == "summary":
        user_prompt = (
            f"Sirket ID: {company_id}\n"
